      ...
      tableInput: {
        ...
        storageDescriptor: {
          ...
          serdeInfo: {
            ...
            // The v2 JSON records use hyphenated keys; every column whose
            // name differs from its JSON key needs an explicit mapping or
            // the SerDe silently reads NULL for it.
            parameters: {
              ...
              'mapping.cache_behavior_path_pattern': 'cache-behavior-path-pattern',
